...
rev_benefit_trends <- ss_data_cpi |>
    ...
    select(State, `Total Revenue - Per Pupil 2002`, `Total Revenue - Per Pupil 2020`, `Total Benefits Raw Growth`, `Total Revenue Raw Growth`, `Benefit Spending Growth / Revenue Growth`) |>
