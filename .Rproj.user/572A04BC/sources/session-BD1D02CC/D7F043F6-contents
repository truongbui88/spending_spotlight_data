...
rev_benefit_trends <- ss_data_cpi |>
    ...
    select(State, `Total Benefits - Per Pupil 2002`, `Total Benefits - Per Pupil 2020`, `Total Benefits Raw Growth`, `Total Revenue Raw Growth`, `Benefit Spending Growth / Revenue Growth`) |>
    mutate_at(vars(`Total Revenue Raw Growth`, `Total Benefits Raw Growth`), round, 0) |>
